 ...
 * Generated at: 2019-09-23 09:48:14 UTC
...
public final class deleteSelectGoods_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.print(basePath);
      out.write("\">\r\n");
      out.write("    <title>selectGoods.jsp</title>\r\n");
      ...
      out.write("  \t\t\tvar n = document.deleteForm.ids.length;\r\n");
      out.write("  \t\t\tvar count = 0;//统计没有选中的个数\r\n");
      out.write("  \t\t\tfor(var i = 0; i < n; i++){\r\n");
      out.write("  \t\t\t\tif(!document.deleteForm.ids[i].checked){\r\n");
      out.write("  \t\t\t\t\tcount++;\r\n");
      out.write("  \t\t\t\t}else{\r\n");
      out.write("  \t\t\t\t\tbreak;\r\n");
      out.write("  \t\t\t\t}\r\n");
      out.write("  \t\t\t}\r\n");
      out.write("  \t\t\tif(n > 1){\r\n");
      out.write("  \t\t\t\tif(count == n){\r\n");
      out.write("  \t\t\t\t\talert(\"请选择被删除的商品！\");\r\n");
      out.write("  \t  \t\t\t\tcount = 0;\r\n");
      out.write("  \t  \t\t\t\treturn false;\r\n");
      out.write("  \t\t\t\t}\r\n");
      out.write("  \t\t\t}else{\r\n");
      out.write("  \t  \t\t\tif(!document.deleteForm.ids.checked){\r\n");
      out.write("  \t  \t\t\t\t\talert(\"请选择被删除的商品！\");\r\n");
      out.write("  \t  \t\t\t\t\treturn false;\r\n");
      out.write("  \t  \t\t\t}\r\n");
      out.write("  \t\t\t}\t\r\n");
      out.write("  \t\t\r\n");
      out.write("  \t\t\tif(window.confirm(\"真的删除吗？really?\")){\r\n");
      ...
      out.write("  \t\t\tif(window.confirm(\"是否删除该商品？\")){\r\n");
      out.write("  \t\t\t\twindow.location.href = \"/ch20/adminGoods/deleteAGoods?id=\"+id;\r\n");
      out.write("  \t\t\t}\r\n");
      out.write("  \t\t}\r\n");
      out.write("  </script>\r\n");
      out.write("</head>\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(68,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(71,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t<form action=\"adminGoods/deleteGoods\" name=\"deleteForm\">\r\n");
        out.write("\t\t<table border=\"1\" bordercolor=\"PaleGreen\">\r\n");
        out.write("\t\t\t<tr>\r\n");
        out.write("\t\t\t\t<th width=\"100px\">ID</th>\r\n");
        out.write("\t\t\t\t<th width=\"200px\">名称</th>\r\n");
        out.write("\t\t\t\t<th width=\"200px\">价格</th>\r\n");
        ...
        out.write("\t\t\t\t\t<input type=\"button\" value=\"删除\" onclick=\"confirmDelete()\">\r\n");
        out.write("\t\t\t\t</td>\r\n");
        out.write("\t\t\t</tr>\r\n");
        out.write("\t\t\t<tr>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(82,3) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/admin/deleteSelectGoods.jsp(82,3) '${allGoods }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${allGoods }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(82,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${goods.id }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("\" target=\"_blank\">详情</a></td>\r\n");
          out.write("\t\t\t\t\t<td>\r\n");
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(104,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f0.setVar("url_pre");
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(104,5) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fparam_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005furl_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(105,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fparam_005f0.setName("pageCur");
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(105,6) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fparam_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005furl_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(106,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fparam_005f1.setName("act");
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(106,6) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fparam_005f1.setValue("deleteSelect");
  ...
  private boolean _jspx_meth_c_005furl_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(108,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f1.setVar("url_next");
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(108,5) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fparam_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005furl_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(109,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fparam_005f2.setName("pageCur");
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(109,6) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fparam_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005furl_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(110,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fparam_005f3.setName("act");
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(110,6) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fparam_005f3.setValue("deleteSelect");
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(113,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageCur != 1 }", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/deleteSelectGoods.jsp(117,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageCur != totalPage && totalPage != 0}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
